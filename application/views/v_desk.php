...
<div class="container">
	...
	<div class="alert alert-primary mt-4 mb-4" role="alert">
	  Konten diperbaharui dalam <span id="detik"></span> detik 
		...
		<h3 class="text-center">AREA KOPI (<?= count($kopiNoDO) + count($kopiDO)?>)</h3>
	</div>
		<div class="col-md-6 col-sm-12" >
			<div class="server-rack" >			
					<p class="label">KOPI Belum dapat Nomer DO 
					</P>
					<div id="tes"></div>
		...
		<div class="col-md-6 col-sm-12">
			...
			<?php if(count($kopiDO) > 0):?>			
				...
				<div href="#" class="infokopido" data-do="<?= $knd['NoDo'] ?>" data-toggle="modal" data-target="#infokopido">
				<div class="server">
...
<div class="row" >
	...
	<div class="col-md-4" >
			<div class="server-rack" >			
					<p class="label">STTP Belum Register di Gudang</P>
...
<!-- Area BISKUIT CENTER -->
	...
	<div class="col-md-12">
		...
		<div class="col-md-6" >
			<div class="server-rack">			
					<p class="label">Belum Register di Gudang</P>
					<div id="tes"></div>
...
<!-- Area BISKUIT JABON -->
	...
	<div class="col-md-12">
		...
		<div class="col-md-6" >
			<div class="server-rack" >			
					<p class="label">Jabon Belum Register di Gudang</P>
					<div id="tes"></div>
	...
	<script>
		...
		$('.infokopido').on('click', function (){
			var nodo = $(this).attr("data-do");
			 var htmlvalue;
				$.ajax({
					type : "POST",
					url  : "<?= site_url('AntrianDesk/infoDO')?>",
					dataType : "text",
					data : {nodo:nodo},
		...
		$('.informasi').on('click', function (){
			...
			var nodo 	= $(this).attr("data-nodo");
				...
				$.ajax({
					type : "POST",
					url  : "<?= site_url('AntrianDesk/infoNopol')?>",
					dataType : "text",
					data : {nopol:nopol,flag:flag,nodo:nodo},
					 success: function(response){
						$('.modal-body').empty();
						$('.modal-body').html(response);
						$('#do').html("Nopol: "+nopol);	;	
